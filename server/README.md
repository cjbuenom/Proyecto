...
docker build -t us.gcr.io/proyectogchome/serverclonestackoverflow .

docker push us.gcr.io/proyectogchome/serverclonestackoverflow
...
se administra cadena para acceso a db mongo
